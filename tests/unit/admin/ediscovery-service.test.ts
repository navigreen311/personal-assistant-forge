...
describe('EDiscoveryService', () => {
  ...
  describe('requestExport', () => {
    ...
    it('should include dateRange in the export request', async () => {
      ...
      const result = await requestExport(verifiedEntityIdForTest('entity-1'), 'admin-user', { start, end }, ['messages']);
  ...
  describe('listExports', () => {
    it('should return all exports for a given entity', async () => {
      ...
      const results = await listExports(verifiedEntityIdForTest('entity-1'));
    ...
    it('should return empty array for entity with no exports', async () => {
      const results = await listExports(verifiedEntityIdForTest('nonexistent-entity'));
